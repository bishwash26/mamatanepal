...
const Discussions = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      {!user && (
        <div className="bg-primary-50 border-l-4 border-primary-500 p-4 mb-6 flex justify-between items-center" role="alert">
          <div>
      ...
      {/* Posts List */}
      <section aria-label="Discussion posts">
              ...
              <div className="flex justify-between items-center text-sm text-gray-600">
                ...
                <div className="flex items-center space-x-4">
                  <button 
                    ...
                    aria-label={post.user_has_liked ? 'Unlike this post' : 'Like this post'}
                  >
                    <Heart 
                      size={16} 
        ...
        {posts.length === 0 && !loading && (
          <div className="text-center py-12 bg-white rounded-lg shadow-sm">
            <p className="text-gray-500 text-lg">
              {t('No discussions yet. Be the first to start a conversation!')}
            </p>
          </div>
        )}
      ...
      {/* Create Post Modal */}
      {isModalOpen && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50" role="dialog" aria-modal="true" aria-labelledby="create-post-title">
          <div className="bg-white rounded-lg max-w-lg w-full p-6">
            <div className="flex justify-between items-center mb-4">
              <h2 id="create-post-title" className="text-2xl font-semibold text-gray-800">
                {t('Create New Post')}
              </h2>
              <button
